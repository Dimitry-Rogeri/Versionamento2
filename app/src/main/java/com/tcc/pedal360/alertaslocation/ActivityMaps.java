...
public class ActivityMaps extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng home = new LatLng(-16.071554, -48.030118);
        mMap.addMarker(new MarkerOptions().position(home).title("Marcador em Recife"));

        CameraPosition cameraPosition = new CameraPosition.Builder().zoom(15).target(home).build();
